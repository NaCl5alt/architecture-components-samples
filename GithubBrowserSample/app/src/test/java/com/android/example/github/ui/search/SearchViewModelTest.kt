...
class SearchViewModelTest {
    ...
    @Test
    fun empty() {
        val result = mock<Observer<com.android.example.model.Resource<List<com.android.example.model.Repo>>>>()
    ...
    @Test
    fun swap() {
        val nextPage = MutableLiveData<com.android.example.model.Resource<Boolean>>()
